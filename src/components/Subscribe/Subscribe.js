              ...
              .then(res => {
                ...
                addNewSubscriber({
                  ...
                  .then(() => {
                    ...
                    handleLocalStorage({
                      name: CONSTANTS.P_EMAIL,
                      value: email.value
                    });
                    // Whatsapp Logger
                    setLogs({
                      action: "Subscribe",
                      message: `just subscribed with ${email.value}`
                    });
                  })
                  .catch(error => {
    ...
    <div>
      ...
      >
        ...
        <DialogTitle id="form-dialog-title">
          {!email.sent && !email.subscribed ? `Subscribe` : ""}
        </DialogTitle>
        ...
        <DialogActions>
          ...
          {!email.sent && !email.loading && !email.subscribed && (
