  ...
  return (
    <div className={{ flexGrow: 1 }}>
      <AppBar
        position="fixed"
        color="primary"
        style={travel ? { background: "#000" } : null}
      >
        <Toolbar style={{ minHeight: "45px" }}>
          ...
          {!travel ? (
            ...
            <HomeIcon
              style={{ color: "#fff" }}
              onClick={() => (iamin ? setPage("Home") : setPage("Setup"))}
            />
          )
          // ?<HomeIcon />
          // :null
          ...
          >
            ...
            >
              <span>
                {place ? (
                  <>
                    {place != "undefined" ? place.substr(0, 24) : ""}
                    {travel && address && (
                      <InfoMessage message={`You are closer to : ${address}`} />
                    )}
                  </>
                ) : (
                  ""
              ...
              <span style={{ padding: "0 0 0 3px", fontWeight: "normal" }}>
